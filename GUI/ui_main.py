...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.workerCountLabel = QtWidgets.QLabel(self.centralwidget)
        self.workerCountLabel.setGeometry(QtCore.QRect(70, 330, 91, 31))
        self.workerCountLabel.setObjectName("workerCountLabel")
        self.workerCountSpinBox = QtWidgets.QSpinBox(self.centralwidget)
        self.workerCountSpinBox.setGeometry(QtCore.QRect(170, 330, 71, 31))

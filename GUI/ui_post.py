...
class Ui_PostProcessSettingDialog(object):
    def setupUi(self, PostProcessSettingDialog):
        ...
        self.AddQButton_Enclosure = QtWidgets.QPushButton(PostProcessSettingDialog)
        self.AddQButton_Enclosure.setGeometry(QtCore.QRect(620, 140, 231, 41))
        self.AddQButton_Enclosure.setObjectName("AddQButton_Enclosure")
        self.AddQButton_Volume = QtWidgets.QPushButton(PostProcessSettingDialog)
        self.AddQButton_Volume.setGeometry(QtCore.QRect(620, 180, 231, 41))
        self.AddQButton_Volume.setObjectName("AddQButton_Volume")
        self.AddQButton_Surface = QtWidgets.QPushButton(PostProcessSettingDialog)
        self.AddQButton_Surface.setGeometry(QtCore.QRect(620, 220, 231, 41))
        self.AddQButton_Surface.setObjectName("AddQButton_Surface")
    ...
    def retranslateUi(self, PostProcessSettingDialog):
        ...
        self.AddLossButton_Enclosure.setText(_translate("PostProcessSettingDialog", "添加Loss of enclosure表面损耗"))
        self.AddLossButton_Volume.setText(_translate("PostProcessSettingDialog", "添加All volume losses材料损耗"))
        self.AddLossButton_Surface.setText(_translate("PostProcessSettingDialog", "添加All surface losses全损耗"))
        self.AddQButton_Enclosure.setText(_translate("PostProcessSettingDialog", "添加Q of enclosure 表面Q值"))
        self.AddQButton_Volume.setText(_translate("PostProcessSettingDialog", "添加All volume Q 材料Q值"))
        self.AddQButton_Surface.setText(_translate("PostProcessSettingDialog", "添加All surface Q 全部Q值"))

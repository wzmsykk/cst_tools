    ...
    def do(self):
        ...
        for i in range(5):
            ...
            self.log.logger.info(
                "changed paramname %s, paramvalue %s"
    ...
    def do(self):
        ...
        if freqLock != True:
            while fcount <= fcountmax:
                ...
                pgrad = self.pGradiFromXiYR0_norm(
                    x0, dindex, self.yFunc2, r0, self.step, nor
                )
                print("x0=", x0, file=self.log, flush=True)
        ...
        while self.runcount <= self.maxcount:
            ...
            pgrad = self.pGradFromXYR0_norm_parallel(
                x0, self.yFunc2, r0, self.step, nor
            )
            ...
            pgrad2 = self.pGradiFromXiYR0_norm(
                x1, dindex, self.yFunc2, r1, self.step, nor
            )

...
Sub postProcess(saveDir As String,id As Variant)
	...
	radius = RestoreDoubleParameter("Req")
	z_0=-RestoreDoubleParameter("Leq")*0.5
	z_t=RestoreDoubleParameter("Leq")*0.5
	...
	End If
	rxy = radius*0.9
	rz = (RestoreDoubleParameter("Leq")*0.5-finconv)*0.9
	...
	Print #99,"Model_Info"
	Print #99,"model_name";vbTab;"R";vbTab;"L";Rtube;"Rtube";vbTab;"Ltube"
	Print #99,"pillbox_with_tube";vbTab;RestoreParameter("R");vbTab;RestoreParameter("L");vbTab;RestoreParameter("Rtube");vbTab;RestoreParameter("Ltube")
...
Sub nextMode(ByRef id As Integer)
	...
	StoreParameter("fmax", Round(freq+2000))
End Sub
...
Sub saveResult(saveDir As String, id As Variant)
	...
	r=RestoreParameter("R")
	l=RestoreParameter("L")
	xmin=-r
	xmax=r
	ymin=-r
	ymax=r
...
Sub MyParameterSweep()
	...
	pt1="D:\pillbox_result\pillbox_tube_modes\"
	start=False

...
Sub iModePostProcess(saveDir As String,id As Variant)
	Dim value As Double
...
Sub iModeSaveResult(saveDir As String, id As Variant)
	...
	i=id
	Open(saveDir & "Mode_" & id & "_FREQ.txt") For Output As #99
	Print #99, "Mode ";id;"/real"
	Print #99, "-----------------"
	Print #99,0;vbTab;EigenmodeSolver.GetModeFrequencyInHz(i)/1E6
	Close #99
...
Sub LinkRL_Interactive()
	If Not DoesParameterExist("Req") Or Not DoesParameterExist("Leq") Then
...
Sub ModeRec_All_output(outputDir As String)
	LinkRL_Interactive()
	SimpleSaveModes(EigenmodeSolver.GetNumberOfModesCalculated, outputDir)
End Sub



Sub SimpleSaveModes(maxcount As Integer,resultDir As String)
	Dim id As Integer
	id=1
	For id=1 To maxcount		
		'check avil modes
		iModePostProcess(resultDir, id)
		iModeSaveResult(resultDir, id)		
	Next id
End Sub
